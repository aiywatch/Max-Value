...
###
puts rent?(true, 4000, false)
puts rent?(true, 1500, false)
puts rent?(true, 4000, true)
puts rent?(true, 1500, true)
puts rent?(false, 4000, true)
puts rent?(false, 1500, true)
puts rent?(false, 4000, false)
puts rent?(false, 1500, false)